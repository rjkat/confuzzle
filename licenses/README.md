...
* licenses: MIT
* repository: https://github.com/mafintosh/node-gyp-build
* publisher: Mathias Buus
* url: @mafintosh
...
* licenses: MIT
* repository: https://github.com/es-shims/String.prototype.trimLeft
* publisher: Jordan Harband
* email: ljharb@gmail.com
